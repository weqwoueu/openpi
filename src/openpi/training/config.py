...
_CONFIGS = [
    ...
    # rtc加最新100集翻快递数据
    TrainConfig(
        name="pi05_tianji_place_parcels",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotTianjiDataConfig(
            repo_id="tianji_pico_place_parcels_v4",
            base_config=DataConfig(prompt_from_task=True),
            state_mode="ee",
        ),
        batch_size=180,
    ...
    TrainConfig(
        name="pi05_tianji_place_parcels_up_and_down",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotTianjiDataConfig(
            repo_id="tianji_pico_place_parcels_down_and_up_v1",
            base_config=DataConfig(prompt_from_task=True),
            state_mode="ee",
        ),
        batch_size=240,
